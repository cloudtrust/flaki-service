...
//go:generate mockgen -destination=./mock/jaeger.go -package=mock -mock_names=JaegerModule=JaegerModule,Jaeger=Jaeger  github.com/cloudtrust/flaki-service/pkg/health JaegerModule,Jaeger
