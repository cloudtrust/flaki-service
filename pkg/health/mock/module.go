...
// Source: github.com/cloudtrust/flaki-service/pkg/health (interfaces: InfluxHealthChecker,JaegerHealthChecker,RedisHealthChecker,SentryHealthChecker,StoreModule)
