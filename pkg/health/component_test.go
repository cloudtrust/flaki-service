...
//go:generate mockgen -destination=./mock/module.go -package=mock -mock_names=HealthChecker=HealthChecker,HealthCheckStorage=HealthCheckStorage  github.com/cloudtrust/flaki-service/pkg/health HealthChecker,HealthCheckStorage
