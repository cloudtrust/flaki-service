...
func TestEndpointLoggingMW(t *testing.T) {
	...
	mockLogger.EXPECT().Log(LoggingCorrelationIDKey, corrID, "took", gomock.Any()).Return(nil).Times(1)
	m(ctx, req)
	...
	mockLogger.EXPECT().Log(LoggingCorrelationIDKey, flakiID, "took", gomock.Any()).Return(nil).Times(1)
	...
	mockLogger.EXPECT().Log(LoggingCorrelationIDKey, "", "took", gomock.Any()).Return(nil).Times(1)
	m(context.Background(), req)
}
...
func TestComponentLoggingMW(t *testing.T) {
	...
	// NextID.
	mockComponent.EXPECT().NextID(ctx, req).Return(reply, nil).Times(1)
	mockLogger.EXPECT().Log("unit", "NextID", LoggingCorrelationIDKey, corrID, "took", gomock.Any()).Return(nil).Times(1)
	m.NextID(ctx, req)
	...
	// NextID without correlation ID.
	mockComponent.EXPECT().NextID(context.Background(), req).Return(reply, nil).Times(1)
	mockLogger.EXPECT().Log("unit", "NextID", LoggingCorrelationIDKey, flakiID, "took", gomock.Any()).Return(nil).Times(1)
	m.NextID(context.Background(), req)

	// NextID error without correlation ID.
	mockComponent.EXPECT().NextID(context.Background(), req).Return(nil, fmt.Errorf("fail")).Times(1)
	mockLogger.EXPECT().Log("unit", "NextID", LoggingCorrelationIDKey, "", "took", gomock.Any()).Return(nil).Times(1)
	m.NextID(context.Background(), req)

	// NextValidID.
	mockComponent.EXPECT().NextValidID(ctx, req).Return(reply).Times(1)
	mockLogger.EXPECT().Log("unit", "NextValidID", LoggingCorrelationIDKey, corrID, "took", gomock.Any()).Return(nil).Times(1)
	...
	mockLogger.EXPECT().Log("unit", "NextValidID", LoggingCorrelationIDKey, flakiID, "took", gomock.Any()).Return(nil).Times(1)
